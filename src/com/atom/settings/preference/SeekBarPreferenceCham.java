...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String BEASTNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, BEASTNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, BEASTNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(BEASTNS, "interval");
            if(newInterval != null)
